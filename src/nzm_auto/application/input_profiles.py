...
class InputProfileName(StrEnum):
    ...
    GAME_WINDOW_MESSAGE = "game-window-message"
    GAME_FOREGROUND_PRECISE = "game-foreground-precise"
...
INPUT_PROFILES = {
    ...
    InputProfileName.GAME_WINDOW_MESSAGE: InputProfile(
        name=InputProfileName.GAME_WINDOW_MESSAGE,
        mouse_method="PostMessage",
        keyboard_method="PostMessage",
        supports_background=True,
        ...
        compatibility="high",
        warning=(
            "向选中的游戏窗口发送后台消息，并启用 MaaFramework 鼠标锁定跟随；"
            "仅适用于已经确认接受后台消息的游戏。"
        ),
    ),
    InputProfileName.GAME_FOREGROUND_PRECISE: InputProfile(
        name=InputProfileName.GAME_FOREGROUND_PRECISE,
        mouse_method="PostMessage",
